...
class UpgradeTests(unittest.TestCase):
    ...
    def test_upgrade_01_real_v1_to_v2_rollback_and_uninstall(self):
        ...
        self.assertFalse((self.code/'agents/architect.toml').exists())
        self.assertTrue((self.code/'agents/deep-reviewer.toml').is_file())
        self.assertTrue((self.code/'agents/escalation.toml').is_file())
        ...
        self.assertFalse((self.code/'agents/deep-reviewer.toml').exists())
        self.assertFalse((self.code/'agents/escalation.toml').exists())
